function CopSound:init(unit)
	...
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_1/ene_fbi_heavy_1") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_r870/ene_fbi_heavy_r870") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_city_swat_1/ene_city_swat_1") or self._unit:name() == Idstring("units/payday2/characters/ene_city_swat_2/ene_city_swat_2") or self._unit:name() == Idstring("units/payday2/characters/ene_city_swat_3/ene_city_swat_3") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_city_heavy_m4/ene_city_heavy_m4") or self._unit:name() == Idstring("units/payday2/characters/ene_city_heavy_g36/ene_city_heavy_g36") or self._unit:name() == Idstring("units/payday2/characters/ene_city_heavy_r870/ene_city_heavy_r870") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	elseif self._unit:name() == Idstring("units/pd2_dlc_bph/characters/ene_murkywater_heavy/ene_murkywater_heavy") or
			...
			self._unit:name() == Idstring("units/payday2/characters/ene_murkywater_2/ene_murkywater_2") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	--husks		
	...
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_1/ene_fbi_heavy_1_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_fbi_heavy_r870/ene_fbi_heavy_r870_husk") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_city_swat_1/ene_city_swat_1_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_city_swat_2/ene_city_swat_2_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_city_swat_3/ene_city_swat_3_husk") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	elseif self._unit:name() == Idstring("units/payday2/characters/ene_city_heavy_m4/ene_city_heavy_m4_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_city_heavy_g36/ene_city_heavy_g36_husk") or self._unit:name() == Idstring("units/payday2/characters/ene_city_heavy_r870/ene_city_heavy_r870_husk") then
		self._prefix = ("l") .. (nr_variations and tostring(math.random(nr_variations)) or "") .. ("d") .. "_"
	elseif self._unit:name() == Idstring("units/pd2_dlc_bph/characters/ene_murkywater_heavy/ene_murkywater_heavy_husk") or
