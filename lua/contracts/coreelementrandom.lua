...
function ElementRandom:on_executed(...)
	if Global.game_settings and Global.game_settings.level_id == "framing_frame_1" or Global.game_settings.level_id == "gallery" and self._id and self._id == 100515 then
