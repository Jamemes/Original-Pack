...
if string.lower(RequiredScript) == "lib/tweak_data/attentiontweakdata" then
	...
	function AttentionTweakData:init(tweak_data)
		...
		if difficulty == "easy_wish" or difficulty == "sm_wish" then
			...
			self.settings.pl_mask_on_foe_combatant_whisper_mode_stand.notice_requires_FOV = false
			self.settings.pl_mask_on_foe_combatant_whisper_mode_crouch.notice_requires_FOV = false
			self.settings.pl_mask_on_foe_non_combatant_whisper_mode_stand.notice_requires_FOV = false
			self.settings.pl_mask_on_foe_non_combatant_whisper_mode_crouch.notice_requires_FOV = false
			self.settings.civ_all_peaceful.notice_requires_FOV = false
		end
	end
