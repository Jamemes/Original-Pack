...
function HUDStatsScreen:_create_stats_screen_profile(profile_wrapper_panel)
	...
	if Global.game_settings and Global.game_settings.level_id == "arena" then
		track_text:set_text(utf8.to_upper(managers.localization:text("menu_es_playing_track")) .. " " .. "ALESSO: PAYDAY")
	else
		track_text:set_text(utf8.to_upper(managers.localization:text("menu_es_playing_track")) .. " " .. managers.music:current_track_string())
	end
