...
--------------------------------------------------------
		trk_uj_0 = {
			icon_id = "Bank_Heist_DeathWish",
			ladder = "H_BankR",
			sort_name = "Bank_Heist_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_uc_0 = {
			icon_id = "Arm_DeathWish",
			ladder = "H_TransportCrossroads",
			sort_name = "Arm_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_tu_0 = {
			icon_id = "FirestarterPro_DeathWish",
			ladder = "H_Firestarter",
			sort_name = "FirestarterPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_tt_0 = {
			icon_id = "AlexPro_DeathWish",
			ladder = "H_Rats",
			sort_name = "AlexPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_tp_0 = {
			icon_id = "WatchdogsPro_DeathWish",
			ladder = "H_Watchdogs",
			sort_name = "WatchdogsPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_th_0 = {
			icon_id = "FramingFramePro_DeathWish",
			ladder = "H_FramingFrame",
			sort_name = "FramingFramePro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_td_0 = {
			icon_id = "ElectionDayPro_DeathWish",
			ladder = "H_ElectionDay",
			sort_name = "ElectionDayPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_tc_0 = {
			icon_id = "MiaPro_DeathWish",
			ladder = "H_HotlineMiami",
			sort_name = "MiaPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_sx_0 = {
			icon_id = "HoxPro_DeathWish",
			ladder = "H_HoxBreakout",
			sort_name = "HoxPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_sr_0 = {
			icon_id = "KenazPro_DeathWish",
			ladder = "H_GoldenGrin",
			sort_name = "KenazPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_sw_0 = {
			icon_id = "PetaPro_DeathWish",
			ladder = "H_GoatSim",
			sort_name = "PetaPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_sf_0 = {
			icon_id = "BornPro_DeathWish",
			ladder = "H_Biker",
			sort_name = "BornPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
		...
		trk_sa_0 = {
			icon_id = "RvdPro_DeathWish",
			ladder = "H_Reservoir",
			sort_name = "RvdPro_DeathWish",
			additional_id = true,
			tags = {
				tags.progress.completion,
				tags.difficulty.death_wish,
